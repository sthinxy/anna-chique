...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Bh_ol-Kv.mjs");
...
const manifest = {
  "9a6541631cbabffa401ef96c2dda0cd1d325a204b0a29f86a9be21d9a76d4887": {
    functionName: "getPublicProducts_createServerFn_handler",
    importer: () => import("./public-data.functions-CyPRswzm.mjs")
  },
  "17c8262e497437c3378d9208dce103ef6b21a61febdd07e7803cdbe64886443a": {
    functionName: "getPublicSettings_createServerFn_handler",
    importer: () => import("./public-data.functions-CyPRswzm.mjs")
  },
  "e749c72c7ebed0efeb0eb76434ba1a41103739076c003811248ff176710598bc": {
    functionName: "getPublicReviews_createServerFn_handler",
    importer: () => import("./public-data.functions-CyPRswzm.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CKO43llX.mjs").then((n) => n.b),
    import("./start-C5wi-2NU.mjs"),
